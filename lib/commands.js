...
const commands = [
                ...
                switch(args.length) {
                    ...
                    case 0: // No parameters
                        ...
                        let result = Object.entries(categorySet)
                            .map(([category, clist]) => {
                                let clistcomb = clist.map((c) => `> ▫️\`${config.command.prefix}${c.usages[0]}\` ${c.description}\n`)
                    ...
                    default: 
                        ...
                        channel.send(
                            new discord.MessageEmbed()
                                ...
                                .setDescription(`[${command.category}] ${command.description}`)
...

    {
        ...
        argsLength: 1,
        category: '급식',
        description: '몇주 후의 학교 급식을 출력합니다.',
        usages: ['<숫자>주후급식 <학교>'],
    ...
    },
    {
        ...
        argsLength: 5,
        category: '시간표',
        description: '다음주의 시간표를 출력합니다.',
        usages: ['다음주시간표 <학교> <학년도> <학기> <학년> <반>'],
        execute: (message, args, neisClient) => {
    ...
    },
    {
        ...
        argsLength: 5,
        category: '시간표',
        description: '저번주의 시간표를 출력합니다.',
        usages: ['저번주시간표 <학교> <학년도> <학기> <학년> <반>'],
        execute: (message, args, neisClient) => {
            return getCommand('0주후시간표').execute(message, args, neisClient, '-1주후시간표');
        }
    },
...

    {
        ...
        usages: ['<숫자>주후시간표 <학교> <학년도> <학기> <학년> <반>'],
